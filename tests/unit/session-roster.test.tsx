...
describe("session roster", () => {
  ...
  it("shows staff the confirmed players and ordered waitlist", () => {
    ...
    expect(markup).toContain("Character: Navasi — 12345-2701");
  });
});
