...
import { communities, communityMembershipRequests, communitySupportedPrograms, organizedPlayPrograms, people } from "@/db/schema";
...
export default async function CommunitySettingsPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const [programs, selected, invitationResult, pendingRequests] = await Promise.all([
