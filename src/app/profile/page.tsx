...
export default async function ProfilePage() {
  ...
  return <main className="mx-auto min-h-screen max-w-2xl px-6 py-16"><p className="text-sm font-semibold tracking-[0.2em] text-brand uppercase">Account</p><h1 className="mt-3 text-4xl font-semibold">Your profile</h1><p className="mt-3 text-text-muted">Signed in as {profile.email}. Add only the details you want to share in relevant play areas.</p><section className="mt-8 rounded-3xl border border-border bg-surface p-8"><ProfileForm profile={profile} /></section></main>;
}
