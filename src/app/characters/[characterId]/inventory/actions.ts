...
function metadata(formData: FormData) { return { sourceMaterialTitle: formData.get("sourceMaterialTitle"), sourceMaterialIdentity: formData.get("sourceMaterialIdentity"), societyLegal: formData.get("societyLegal"), societyStatus: formData.get("societyStatus"), rarity: formData.get("rarity"), validationNote: formData.get("validationNote") }; }
