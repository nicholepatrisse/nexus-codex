...
export function SaleForm({ itemName, available, valueMinor, editHref, action, triggerClassName = "" }: { itemName: string; available: number; valueMinor: number | null; editHref: string; action: (state: SaleState, data: FormData) => Promise<SaleState>; triggerClassName?: string }) {
